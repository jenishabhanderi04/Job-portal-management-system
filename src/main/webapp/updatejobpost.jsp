...
try{
	if(request.getParameter("update")!= null)
	{
	 String update = request.getParameter("update");
		...
		ResultSet rs = s.executeQuery("select * from createjobpost where cjpid ="+update+"");
...
%>
              <form method="post" action="">
                <div class="col-md-12 latest-job ">
                  <div class="form-group">
                    <input type="text"  class="form-control input-lg" id="jobtitle" name="jobtitle" placeholder="Job Title" value="<%= rs.getString("jobtitle") %>" >
                  </div>
                  <div class="form-group">
                    <textarea class="form-control input-lg" id="description" name="description" placeholder="Job Description" value="<%= rs.getString("description") %>" ></textarea>
                  </div>
                  <div class="form-group">
                    <input type="number" class="form-control  input-lg" id="minimumsalary" min="1000" autocomplete="off" name="minimumsalary" placeholder="Minimum Salary" value="<%= rs.getString("minimumsalary") %>"  >
                  </div>
                  <div class="form-group">
                    <input type="number" class="form-control  input-lg" id="maximumsalary" name="maximumsalary" placeholder="Maximum Salary" value="<%= rs.getString("maximumsalary") %>" >
                  </div>
                  <div class="form-group">
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" value="<%= rs.getString("experience") %>"  >
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="qualification" name="qualification" placeholder="Qualification Required" value="<%= rs.getString("qualification") %>"  >
                  </div>
                  <div class="form-group">
            ...
            if(request.getParameter("update")!= null)
	{
		...
		String id = request.getParameter("update");
		    ...
		    PreparedStatement ps = con.prepareStatement("update createjobpost set jobtitle=?,description=?,minimumsalary=?, maximumsalary=?,experience=?,qualification=? where cjpid = ?;");
