...
ResultSet rs = s.executeQuery("select * from createjobpost where user_id="+sessionid+"");
%>
...
<tr>
 ...
 <td><a href="updatejobpost.jsp?update=<%= rs.getString(1)%>" class="edit">Update</a></td> 
<td><a href="deletejobpost.jsp?delete=<%= rs.getString(1)%> " class="del">Delete</a></td>  
