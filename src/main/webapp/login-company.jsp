...
try{
	...
	if(request.getParameter("submit") != null)
	{
		...
		if(request.getParameter("email") != null || request.getParameter("password") != null)
		{
			...
			PreparedStatement ps = con.prepareStatement("SELECT * FROM creg WHERE email = ? and password = ?");
			...
			session.setAttribute("user_name", rs.getString("coname"));
			
			response.sendRedirect("coindex.jsp");
